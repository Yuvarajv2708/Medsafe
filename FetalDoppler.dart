...
class FetalDoppler extends StatefulWidget {
  const FetalDoppler({super.key});

  @override
  State<FetalDoppler> createState() => _FetalDopplerState();
}

class _FetalDopplerState extends State<FetalDoppler> {
  @override
