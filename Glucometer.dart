...
class Glucometer extends StatefulWidget {
  const Glucometer({super.key});

  @override
  State<Glucometer> createState() => _GlucometerState();
}

class _GlucometerState extends State<Glucometer> {
  @override
