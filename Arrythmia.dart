...
class Arrythmia extends StatefulWidget {
  const Arrythmia({super.key});

  @override
  State<Arrythmia> createState() => _ArrythmiaState();
}

class _ArrythmiaState extends State<Arrythmia> {
  @override
