...
class Heartlungmachine extends StatefulWidget {
  const Heartlungmachine({super.key});

  @override
  State<Heartlungmachine> createState() => _HeartlungmachineState();
}

class _HeartlungmachineState extends State<Heartlungmachine> {
  @override
            ...
            Container(
              child: Column(
                children: [
                  Row(
                    children: [
                      Image.asset("assets/Angiography.jpg",width: 400,height: 200,),
                    ],
                  ),
                  SizedBox(height: 20,),
                  Container(
