...
class Defibrillator extends StatefulWidget {
  const Defibrillator({super.key});

  @override
  State<Defibrillator> createState() => _DefibrillatorState();
}

class _DefibrillatorState extends State<Defibrillator> {
  @override
